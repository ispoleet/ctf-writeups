...
============================== 25 ==============================
[+] VM program size: 0xA94
Not big endian with no decryption key: Invalid instruction type: 0x5
[+] VM program size: 0xA94
Not little endian with no decryption key: Invalid instruction type: 0x5
[+] VM program size: 0xA94
Not big endian with decryption key #1: Invalid instruction type: 0x7
[+] VM program size: 0xA94
[+] 0x004: SUB   SP, SP, 0x100            | R:[1000, 12, 0, 0, 0, 0...0, 1EF8, 0]              
[+] 0x008: MOV   R2, 0x342E8AE0CBD1751F   | R:[1000, 12, 342E8AE0CBD1751F, 0, 0, 0...0, 1EF8, 0] 
[+] 0x014: AND   R1, R1, R2               | R:[1000, 12, 342E8AE0CBD1751F, 0, 0, 0...0, 1EF8, 0] 
[+] 0x018: S.NE  R1, R1, 0x12             | R:[1000, 0, 342E8AE0CBD1751F, 0, 0, 0...0, 1EF8, 0] 
[+] 0x01C: JCC   0xA64 (R1)               | R:[1000, 0, 342E8AE0CBD1751F, 0, 0, 0...0, 1EF8, 0] 
[+] 0x024: MOV   R3, 0x7D0878D27D0878D2   | R:[1000, 0, 342E8AE0CBD1751F, 7D0878D27D0878D2, 0, 0...0, 1EF8, 0] 
[+] 0x030: ADD   R1, SP, 0x0              | R:[1000, 1EF8, 342E8AE0CBD1751F, 7D0878D27D0878D2, 0, 0...0, 1EF8, 0] 
[+] 0x034: ADD   R4, R3, 0x0              | R:[1000, 1EF8, 342E8AE0CBD1751F, 7D0878D27D0878D2, 7D0878D27D0878D2, 0...0, 1EF8, 0] 
[+] 0x038: ADD   R5, R1, R3               | R:[1000, 1EF8, 342E8AE0CBD1751F, 7D0878D27D0878D2, 7D0878D27D0878D2, 7D0878D27D0897CA...0, 1EF8, 0] 
Not little endian with decryption key #1: bytearray index out of range
[+] VM program size: 0xA94
Not big endian with decryption key #2: Invalid instruction type: 0x7
[+] VM program size: 0xA94
[+] 0x004: SUB   SP, SP, 0x100            | R:[1000, 12, 0, 0, 0, 0...0, 1EF8, 0]              
[+] 0x008: MOV   R2, 0xFFFFFFFF           | R:[1000, 12, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]       
[+] 0x014: AND   R1, R1, R2               | R:[1000, 12, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]       
[+] 0x018: S.NE  R1, R1, 0x12             | R:[1000, 0, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]        
[+] 0x01C: JCC   0xA64 (R1)               | R:[1000, 0, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]        
[+] 0x024: MOV   R3, 0x0                  | R:[1000, 0, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]        
[+] 0x030: ADD   R1, SP, 0x0              | R:[1000, 1EF8, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]     
[+] 0x034: ADD   R4, R3, 0x0              | R:[1000, 1EF8, FFFFFFFF, 0, 0, 0...0, 1EF8, 0]     
[+] 0x038: ADD   R5, R1, R3               | R:[1000, 1EF8, FFFFFFFF, 0, 0, 1EF8...0, 1EF8, 0]  
...
[+] 0x048: S.EQ  R5, R3, 0x100            | R:[1000, 1EF8, FFFFFFFF, 2, 2, 0...0, 1EF8, 0]     
[+] 0x04C: JCC   0x10 (R5)                | R:[1000, 1EF8, FFFFFFFF, 2, 2, 0...0, 1EF8, 0]     
[+] 0x054: JMP   0x1C (R31)      ┌─[11:22:07]─[ispo@ispo-glaptop2]─[~/ctf/hxp_2024/mbins/mbins]
└──> time ./mbins_vm_custom_emu_crack.py 
[+] mbins VM custom emulator crack started.
============================== 17 ==============================
[+] VM program size: 0xA8C
